  ...
  (function($, undefined) {
    ...
    $.TimePicker.prototype = {
      ...
      _items: function(i, startTime) {
        ...
        if (i.options.acceptNull == true) {
          item = $('<li>').addClass('ui-menu-item').appendTo(ul);
          $('<a>').addClass('ui-corner-all').text(nullTime).appendTo(item);
          item.data('time-value', nullTime);
        }
      ...
      select: function(i, item) {
        ...
        clearTimeout(widget.closing);
        a = item.children('a').text()
        if (a == nullTime) { widget.setTime(instance, nullTime); }
        else { widget.setTime(instance, $.fn.timepicker.parseTime(a)); }
